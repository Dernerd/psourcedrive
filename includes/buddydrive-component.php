...
class BuddyDrive_Component extends BP_Component {
	...
	public function setup_globals( $args = array() ) {
		...
		$globals = array(
			...
			'has_directory'         => true,
			'directory_title'       => sprintf( __( '%s Downloadseite', 'buddydrive' ), buddydrive_get_name() ),
			'notification_callback' => 'buddydrive_format_notifications',
			'search_string'         => __( 'Dateien suchen...', 'buddydrive' )
		);
	...
	public function setup_nav( $main_nav = array(), $sub_nav = array() ) {
		...
		if ( ! buddydrive_use_deprecated_ui() && bp_is_my_profile() ) {
			$sub_nav[] = array(
				'name'            => __( 'Zwischen Mitgliedern', 'buddydrive' ),
				'slug'            => 'members',
				'parent_url'      => $buddydrive_link,
				'parent_slug'     => $this->slug,
				'screen_function' => array( 'BuddyDrive_Screens', 'user_files' ),
		...
		if ( is_user_logged_in() ) {
			...
			if ( ! buddydrive_use_deprecated_ui() ) {
				$wp_admin_nav[] = array(
					...
					'title'  => __( 'Zwischen Mitgliedern', 'buddydrive' ),
	...
	public function register_post_types() {
		...
		$labels_file = array(
			'name'	             => __( 'BuddyDateien', 'buddydrive' ),
			'singular'           => __( 'BuddyDatei', 'buddydrive' ),
			'menu_name'          => __( 'PS Buddy Drive Dateien', 'buddydrive' ),
			'all_items'          => __( 'Alle PS BuddyDateien', 'buddydrive' ),
			'singular_name'      => __( 'BuddyDatei', 'buddydrive' ),
			'add_new'            => __( 'Neue BuddyDatei hinzufügen', 'buddydrive' ),
			'add_new_item'       => __( 'Neue BuddyDatei hinzufügen', 'buddydrive' ),
			'edit_item'          => __( 'BuddyDatei bearbeiten', 'buddydrive' ),
			'new_item'           => __( 'Neue BuddyDatei', 'buddydrive' ),
			'view_item'          => __( 'BuddyDatei anzeigen', 'buddydrive' ),
			'search_items'       => __( 'BuddyDateien durchsuchen', 'buddydrive' ),
			'not_found'          => __( 'Keine BuddyDateien gefunden', 'buddydrive' ),
			'not_found_in_trash' => __( 'Keine BuddyDateien im Papierkorb gefunden', 'buddydrive' )
		);

		$args_file = array(
			'label'	            => __( 'BuddyDatei', 'buddydrive' ),
			'labels'            => $labels_file,
			'public'            => false,
			'rewrite'           => false,
			'show_ui'           => false,
		...
		$labels_folder = array(
			'name'	             => __( 'BuddyOrdner', 'buddydrive' ),
			'singular'           => __( 'BuddyOrdner', 'buddydrive' ),
			'menu_name'          => __( 'PS Buddy Drive Ordner', 'buddydrive' ),
			'all_items'          => __( 'Alle BuddyOrdner', 'buddydrive' ),
			'singular_name'      => __( 'BuddyOrdner', 'buddydrive' ),
			'add_new'            => __( 'Neuen BuddyOrdner hinzufügen', 'buddydrive' ),
			'add_new_item'       => __( 'Neuen BuddyOrdner hinzufügen', 'buddydrive' ),
			'edit_item'          => __( 'BuddyOrdner bearbeiten', 'buddydrive' ),
			'new_item'           => __( 'Neuer BuddyOrdner', 'buddydrive' ),
			'view_item'          => __( 'BuddyOrdner anzeigen', 'buddydrive' ),
			'search_items'       => __( 'BuddyOrdner durchsuchen', 'buddydrive' ),
			'not_found'          => __( 'Keine BuddyOrdner gefunden', 'buddydrive' ),
			'not_found_in_trash' => __( 'Keine BuddyOrdner im Papierkorb gefunden', 'buddydrive' )
		);

		$args_folder = array(
			'label'	            => __( 'BuddyOrdner', 'buddydrive' ),
